"use strict";
(self["webpackChunkadmin"] = self["webpackChunkadmin"] || []).push([["src_pages_blog_ts"],{

/***/ "./src/model/BlogModel.ts":
/*!********************************!*\
  !*** ./src/model/BlogModel.ts ***!
  \********************************/
...
/* harmony export */   BlogStatus: () => (/* binding */ BlogStatus),
/* harmony export */   "default": () => (/* binding */ BlogModel)
/* harmony export */ });
class BlogModel {
    constructor() {
        this.id = 0;
...
/* harmony import */ var _model_BlogModel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../model/BlogModel */ "./src/model/BlogModel.ts");
...
var gApiMainPath = _constants_APIConstants__WEBPACK_IMPORTED_MODULE_1__.PATH_API_BLOG;
var gTransformData = [
    {
        name: "status",
        to: "checkbox",
        fields: _model_BlogModel__WEBPACK_IMPORTED_MODULE_4__.BlogStatus,
    }
];
/**
...
var gPageInteraction = new _utilities_Interaction__WEBPACK_IMPORTED_MODULE_3__["default"]()
    .setModel(_model_BlogModel__WEBPACK_IMPORTED_MODULE_4__["default"])
    .setPath(gApiMainPath)
    .setViewPath(_constants_webConstants__WEBPACK_IMPORTED_MODULE_2__.PATH_BLOG)
...
function onLoad() {
    return __awaiter(this, void 0, void 0, function* () {
        yield gPageInteraction
            ...
            .setTableHeaders('title', 'photo', 'status')
            .setRequiredFields('title', 'status')
            // Create tabbed interface for organized data entry
            .setPhotoFields("photo")
            .setTextareaFields("body")
            .addSelectFields('status', _model_BlogModel__WEBPACK_IMPORTED_MODULE_4__.BlogStatus, null, null, false)
            // Initialize the page with all configurations
            .connectButton();
        var vDiv = $("<div>").attr('id', 'test-editor').addClass('border');
        $("#main-container").append(vDiv);
    });
}
...
//# sourceMappingURL=src_pages_blog_ts.bundle.js.map